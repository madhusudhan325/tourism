	       ...
	       // List<Book>  books=new ArrayList<Book>(issueRecord.getBooks());
	        ...
	        helper.setText(" <fieldset>\r\n" + 
        		...
        		"                <td width=\"200px\">\r\n" + 
	        		...
	        		"                </td>\r\n" + 
	        		"                <td>\r\n" + 
	        		"                    <span >"+booking.getHotel().getHotelName()+"</span>\r\n" + 
	        		"                </td>\r\n" + 
	        		"            </tr>\r\n" + 
	        		"            <tr>\r\n" + 
	        		"                <td>\r\n" + 
	        		...
	        		"                </td>\r\n" + 
	        		"                <td>\r\n" + 
	        		"                    <span >"+booking.getCustomer().getFirstName()+" "+booking.getCustomer().getLastName()+"</span>\r\n" + 
	        		"                </td>\r\n" + 
	        		"                <td>\r\n" + 
	        		"                    <label>\r\n" + 
	        		"                        Check In Date :</label>\r\n" + 
	        		...
	        		"                </td>\r\n" + 
	        		"                <td valign=\"top\">\r\n" + 
	        		"                    <span  style=\"color:Red;font-weight:bold;\">"+booking.getCheckoutDate()+"</span>\r\n" + 
	        		"                </td>\r\n" + 
	        		"                <td width=\"200px\">\r\n" + 
	        		"                    <label>\r\n" + 
	        		"                        Booking Price :</label>\r\n" + 
	        		"                </td>\r\n" + 
	        		"                <td>\r\n" + 
	        		"                    <span >"+booking.getBookingPrice()+"</span>\r\n" + 
	        		"                </td>\r\n" + 
	        		"            </tr>\r\n" + 
	        		"            \r\n" + 
//	        		"        </tbody></table>\r\n" + 
